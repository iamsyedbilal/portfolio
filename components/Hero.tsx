...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-[90vh] flex items-center justify-start pt-24 px-6 md:px-16 overflow-hidden">
      {/* Background glow */}
      ...
      <div className="relative z-10 max-w-6xl w-full pt-17.5 flex flex-col lg:flex-row items-center gap-16">
        {/* LEFT — text content */}
